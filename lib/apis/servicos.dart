...
final URL_PRODUTOS = "${URL_SERVICOS.toString()}:5001/produtos";
...
class ServicoProdutos {
  Future<List<dynamic>> getProdutos(
    ...
    final resposta = await http.get(
        Uri.parse("${URL_PRODUTOS.toString()}/$ultimoProduto/$tamanhoPagina"));
  ...
  Future<List<dynamic>> findProdutos(
    ...
    final resposta = await http.get(Uri.parse(
        "${URL_PRODUTOS.toString()}/$ultimoProduto/$tamanhoPagina/$nome"));
    final produtos = jsonDecode(resposta.body);
